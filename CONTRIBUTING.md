...
- Link `svelte-query` locally by running `$ yarn link`
- Auto-build files as you edit by running `$ yarn start`
- Implement your changes and tests to files in the `src/` directory and corresponding test files
- Or use storybook. To run storybook `$ yarn storybook`.
- Document your changes in the appropriate doc page (add stories if necessary)
- Git stage your required changes and commit (see below commit guidelines)
- Submit PR for review

## Commit message conventions

`svelte-query` is using [Angular Commit Message Conventions](https://github.com/angular/angular.js/blob/master/DEVELOPERS.md#-git-commit-guidelines).
